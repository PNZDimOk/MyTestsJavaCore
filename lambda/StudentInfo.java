...
//        info.printStudentOverGarde(students,8);
//        System.out.println("--------------------");
//        info.printStudentUnderAge(students,23);
//        System.out.println("--------------------");
//        info.printStudentsMixCondition(students,22,8.6,'f');
//    }
//    void printStudentOverGarde(ArrayList<Student> al, double garde){
//        for (Student s:al){
//            if(s.avgGrade>garde){
//                System.out.println(s);
//            }
...
class Test{
    private static double avgOfStud(List<Student> list, Function<Student, Double> f){
        double result = 0;
        for (Student st:list){
            result+=f.apply(st);
        }
...
//        System.out.println(students);
        ...
        double res = avgOfStud(students, st -> (double)st.age);
        System.out.println(res);
        Predicate<Student> p1 = student -> student.avgGrade<8.4;
        Predicate<Student> p2 = student -> student.sex=='f';

        info.testStud(students,p2.or(p1));
